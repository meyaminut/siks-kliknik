...
@section('badge')
    <span class="text-xs px-2.5 py-1 rounded-full uppercase font-bold bg-purple-500/20 text-purple-400 border border-purple-500/30">Apoteker</span>
@endsection
@section('content')
<div class="bg-slate-800 border border-slate-700 p-8 rounded-2xl max-w-lg w-full text-center shadow-xl">
    <h2 class="text-2xl font-bold mb-4">Selamat datang di Dashboard Apoteker</h2>
